...
OHCache的使用示例可以查看：[github](https://github.com/fsxtiger/code/blob/master/src/main/java/ohCahe/OHCacheDemo.java)，另外，我也将OHCache简单封装了一下，可以替换java.util.Map，具体代码见：[github](https://github.com/fsxtiger/code/blob/master/src/main/java/ohCahe/OHCacheMap.java)
